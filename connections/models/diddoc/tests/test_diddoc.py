...
class TestDIDDoc(AsyncTestCase):
    async def test_basic(self):
        ...
        dd_in = {
            ...
            "id": "did:bid:LjgpST2rjsoxYegQDRm7EL",
            "publicKey": [
                {
                    "id": "3",
                    "type": "RsaVerificationKey2018",
                    "controller": "did:bid:LjgpST2rjsoxYegQDRm7EL",
            ...
            "authentication": [
                {
                    ...
                    "publicKey": "did:bid:LjgpST2rjsoxYegQDRm7EL#4",
                }
            ],
            "service": [
                {
                    "id": "0",
                    "type": "Agency",
                    "serviceEndpoint": "did:bid:Q4zqM7aXqm7gDQkUVLng9h",
                }
            ],
        }
    ...
    def test_embedded_authkey(self):
        ...
        dd_in = {
            ...
            "publicKey": [
                ...
                {
                    "id": "did:bid:LjgpST2rjsoxYegQDRm7EL#4",
                    "type": "RsaVerificationKey2018",
                    "controller": "did:bid:LjgpST2rjsoxYegQDRm7EL",
                    "publicKeyPem": "-----BEGIN PUBLIC 9...",
                },
            ...
            "authentication": [
                ...
                {
                    "id": "did:bid:LjgpST2rjsoxYegQDRm7EL#6",
                    "type": "RsaVerificationKey2018",
                    "controller": "did:bid:LjgpST2rjsoxYegQDRm7EL",
                    "publicKeyPem": "-----BEGIN PUBLIC A...",
                },
            ...
            "service": [
                {
                    "id": "did:bid:LjgpST2rjsoxYegQDRm7EL;0",
                    "type": "Agency",
    ...
    def test_reference_authkey(self):
        ...
        dd_in = {
            ...
            "publicKey": [
                {
                    "id": "did:bid:LjgpST2rjsoxYegQDRm7EL#3",
                    "type": "RsaVerificationKey2018",
                    "controller": "did:bid:LjgpST2rjsoxYegQDRm7EL",
                    "publicKeyPem": "-----BEGIN PUBLIC X...",
                },
    ...
    def test_minimal_explicit(self):
        ...
        dd_in = {
            ...
            "publicKey": [
                ...
                {
                    "id": "did:bid:LjgpST2rjsoxYegQDRm7EL#keys-4",
                    "type": "RsaVerificationKey2018",
                    "controller": "did:bid:LjgpST2rjsoxYegQDRm7EL",
                    "publicKeyPem": "-----BEGIN PUBLIC A...",
                },
            ...
            "service": [
                {
                    ...
                    "serviceEndpoint": "did:bid:LjgpST2rjsoxYegQDRm7EL;1",
                },
                {
                    "id": "1",
                    "type": "one",
                    ...
                    "recipientKeys": [
                        "~XXXXXXXXXXXXXXXX",
                        "did:bid:LjgpST2rjsoxYegQDRm7EL#keys-1",
                    ],
                    "routingKeys": ["did:bid:LjgpST2rjsoxYegQDRm7EL#keys-4"],
        ...
        assert (
                "routingKeys"
                not in dd.service["did:bid:LjgpST2rjsoxYegQDRm7EL;indy"].to_dict()
        )
        assert all(
            len(dd.service[k].to_dict()["routingKeys"]) == 1
            for k in (
                "did:bid:LjgpST2rjsoxYegQDRm7EL;1",
                "did:bid:LjgpST2rjsoxYegQDRm7EL;2",
            )
        )
            ...
            "service": [
                {
                    ...
                    "type": "DidMessaging",
                    "priority": 1,
                    "recipientKeys": ["did:bid:LjgpST2rjsoxYegQDRm7EL#keys-3"],
                    "serviceEndpoint": "https://www.von.ca",
                }
            ],
        }
    ...
    def test_canon_did(self):
        ...
        with self.assertRaises(ValueError):
            canon_ref(valid_did, ref="did:bid:not-a-DID", delimiter="#")
