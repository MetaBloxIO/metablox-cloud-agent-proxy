...
class TestValid(TestCase):
    ...
    def test_indy_did(self):
        non_indy_dids = [
            ...
            "did:bid:Q4zqM7aXqm7gDQkUVLngZZZ",  # too long
        ...
        INDY_DID["validate"]("did:bid:Q4zqM7aXqm7gDQkUVLng9h")
    ...
    def test_jws_header_kid(self):
        ...
        JWS_HEADER_KID["validate"]("did:bid:Q4zqM7aXqm7gDQkUVLng9h#abc-123")
        JWS_HEADER_KID["validate"](
            "did:bid:Q4zqM7aXqm7gDQkUVLng9h?version-time=1234567890#abc-123"
        )
        JWS_HEADER_KID["validate"](
            "did:bid:Q4zqM7aXqm7gDQkUVLng9h?version-time=1234567890&a=b#abc-123"
        )
        JWS_HEADER_KID["validate"](
            "did:bid:Q4zqM7aXqm7gDQkUVLng9h;foo:bar=low;a=b?version-id=1&a=b#abc-123"
        )
